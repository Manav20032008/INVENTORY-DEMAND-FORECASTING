...
app = FastAPI(title=settings.API_TITLE,version=settings.API_VERSION,description="Production-grade inventory demand forecasting API powered by XGBoost.",lifespan=lifespan)
...
# unversioned  routes for backward competibility
app.include_router(api_router)


@app.get("/", tags=["Root"])
def home():
    return {"message": "Inventory Demand Forecast API","version": settings.API_VERSION,"docs": "/docs","health": f"{settings.API_PREFIX}/health",}
